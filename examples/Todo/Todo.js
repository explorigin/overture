...
O.loader.debug = true;  // So this demo works without a web-server

O.loader.register('fixtures', { src: 'fixtures.js' });
O.loader.register('overture', { src: '../../build/Overture-raw.js' });

O.require(['overture', 'fixtures'], function() {
